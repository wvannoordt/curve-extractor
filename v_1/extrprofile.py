...
class ProfileExtractWindow:
    ...
    def init_gui_elements(self):
        ...
        self.image_canvas.bind("<Motion>", self.on_mouse_move(self))
        self.image_canvas.bind("<B3-Motion>", self.on_mouse3_drag_img(self))
        self.image_canvas.bind("<B1-Motion>", self.on_mouse1_drag_img(self))
        self.image_canvas.bind("<ButtonRelease-3>", self.on_b3_release_img(self))
        self.image_canvas.bind("<ButtonRelease-1>", self.on_b1_release_img(self))
        self.image_canvas.bind("<MouseWheel>", self.on_scroll_img(self))
        self.image_canvas.bind("<Button-1>", self.on_click_img(self))
        self.master.bind_all("<KeyPress>", self.key_press(self))
        self.master.bind_all("<KeyRelease>", self.key_release(self))
        self.x1_entry.bind("<FocusOut>", self.enforce_valid_entries(self))
        self.x2_entry.bind("<FocusOut>", self.enforce_valid_entries(self))
        self.y1_entry.bind("<FocusOut>", self.enforce_valid_entries(self))
        self.y2_entry.bind("<FocusOut>", self.enforce_valid_entries(self))
        self.num_points_entry.bind("<FocusOut>", self.enforce_valid_entries(self))
